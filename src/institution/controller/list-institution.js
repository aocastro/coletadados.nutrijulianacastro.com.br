$(document).ready(function() {
    $('#table-institution').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": "src/institution/model/list-institution",
            "type": "POST"
        },
        "language": {
        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function(data, type, row, meta) {
                    ...
                    <button id="${data}" class="btn btn-danger btn-sm btn-delete"><i class="fa-solid fa-trash-can"></i></button>
                    `
                }
            }
        ]
